...
export const en: Dictionary = {
  ...
  quality: {
    ...
    hint: 'Auto gradually rises when the FPS target holds and falls with hysteresis under load. Manual profiles stay fixed except for an explicit safety fallback; Ultra does not cap the renderer.',
  },
  meta: {
