...
- la géante `ringed-gas` garde un anneau visible à l’entrée, à l’approche et
  après un changement de profil ; l’arc qui passe derrière la planète ne la
...
ils vérifient aussi qu’un anneau sélectionné traverse tous les paliers sans
être reconstruit, que chaque résolution contient le même anneau dessiné et que
l’astre de `ringed-gas` porte bien des anneaux.
