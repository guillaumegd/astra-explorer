...
- **Signes lointains.** Dans le shader des étoiles, sans passe ni texture supplémentaire, un pulsar lointain lance un bref éclat bleuté à chaque passage de faisceau, toutes les 4 à 10 secondes. Un trou noir lointain est un point plus chaud, un peu plus sombre, qui ondule lentement. Ces signes n'existent que tant que le halo du point fait moins de 4 px et disparaissent complètement à 8 px : dès qu'on distingue l'objet, il n'est jamais habillé. Le trou noir n'a volontairement ni anneau ni cœur sombre, car dessiné en anneau il ressemblait à un pulsar. En mouvement réduit, ces signes sont figés. Les comètes n'ont pas de signe visuel.
...
- **La dérive.** **Découvrir** lance un voyage sans fin : étoiles, vues de système, planètes (parfois survolées de près), nébuleuses, respirations en vue galaxie et phénomènes. Les trois premières étapes ne montrent que du ciel ordinaire, jamais le premier système. Ensuite, environ une destination sur trois est un phénomène, en priorité un phénomène pas encore découvert. La catégorie est tirée d'abord, avec des poids qui favorisent les plus saisissants : trou noir 3, pulsar 2,5, vestige 2, comète 1,5, nébuleuse et étoile double 1. Un trou noir revient ainsi environ une étape sur onze, alors qu'avec un tirage uniforme, un visiteur qui enchaînait les étapes n'en croisait qu'un sur plusieurs dizaines. Les comètes sont cadrées sur leur chevelure, à 12 rayons de noyau, pendant tout l'arrêt. Le cadrage sur l'enveloppe complète (128 rayons), puis sur un quart de celle-ci, les laissait minuscules : loin de son étoile, la queue ne mesure qu'environ 26 rayons. Une queue active déborde du cadre. Une fois tout découvert, les phénomènes ne reviennent qu'environ une fois sur seize. Les vingt dernières destinations ne sont pas revisitées, et un même type d'étape ne revient jamais trois fois de suite.

Le voyage lui-même porte la contemplation, et les arrêts sont courts : 14 à 26 secondes, 20 à 32 pour un phénomène ou une région, 8 à 14 en vue galaxie (×1,5 en mouvement réduit). Les trajets durent de 8 à 16 secondes selon l'ampleur du zoom (`sampleContemplativeTravel`, `lib/drift.ts`, chargé avec la dérive). L'astre quitté s'éloigne visiblement, la vue se déplace à distance de croisière, puis la destination grandit. Les deux extrémités s'attardent là où l'astre est vraiment visible, et chaque phase reçoit un temps proportionnel à ce qu'elle parcourt. Les étapes vers la galaxie, une région ou une vue système suivent le même profil. Plusieurs défauts faisaient disparaître l'astre quitté au début du trajet, parfois pour le faire revenir pendant qu'il s'éloignait. Ils sont corrigés, pour la dérive comme pour la navigation manuelle :

- **Point de départ figé.** Il restait immobile pendant que la galaxie tournait. Il suit désormais l'astre ou la région quittés.
- **Rendu détaillé perdu.** L'astre quitté le perdait dès qu'il n'était plus sélectionné. Il le garde pendant tout le trajet.
- **Retard d'une image.** La dérive lance ses étapes au milieu d'une image : la pose de départ de la caméra avait une image de retard sur le centre de visée. Or la galaxie déplace un astre d'environ 0,003 unité par image, soit des dizaines de fois la distance de la caméra. La pose de départ est désormais recalée.
- **Composition et parallaxe de la vue galaxie.** Le décalage de composition et la parallaxe de la souris s'appliquaient dès qu'aucun astre n'était sélectionné, y compris tout près d'une planète ou d'une région cadrée. Ils montent désormais avec la distance, entre 4 et 20 unités.
- **Recentrage.** Sans phase de déplacement propre, il suivait l'horloge. Il suit désormais le zoom : en s'éloignant, il attend la moitié du recul (en échelle logarithmique) ; en s'approchant, il se termine à mi-chemin.

Les trajets manuels gardent leur durée de 5 secondes. Pendant l'arrêt, la caméra orbite autour de l'astre, un tour en 70 secondes environ, à contre-sens de la rotation propre des astres : plus rapide que cette rotation, une orbite dans le même sens faisait paraître la surface tourner à l'envers, avec une lente montée et descente du point de vue sur 80 secondes, pour le montrer sous plusieurs angles. Près du sol, elle glisse le long de la surface. Sur une planète ou une lune à surface solide, une étape sur deux devient une descente : 3 s de cadrage, 16 s de descente jusqu'à environ 1,1 rayon (la vue s'incline vers l'horizon et montre le relief), 10 s de survol, 13 s de remontée jusqu'à 2,6 rayons, puis 4 s d'orbite. Les géantes gazeuses, sans relief, n'y ont pas droit. En mouvement réduit, ni orbite ni descente. La pause fige la dérive. L'interface s'efface au bout de 2 secondes au lieu de 10, et les repères de système sont masqués. Bouger la souris réaffiche l'interface sans arrêter la dérive. Les flèches ← et → du clavier, comme les chevrons de la barre, passent tout de suite à l'étape suivante, tirée au hasard comme si l'arrêt avait pris fin ; elles fonctionnent même quand le focus n'est pas sur la scène, tant qu'aucun panneau n'est ouvert. Un appui sur la scène, la molette, une touche, un repère ou n'importe quelle commande de navigation rend la main à l'endroit où l'on se trouve. Si un changement de densité retire l'astre suivi, la dérive passe à l'étape suivante. Le choix des étapes vit dans `lib/drift.ts`, un module pur et testé ; `?diagnostics=1&driftScale=0.1` raccourcit les arrêts pour les contrôles visuels.

Les trous noirs n'ont plus de jets (17 septembre 2026) : dessinés comme deux cônes lumineux, ils les faisaient passer pour des pulsars. Le tirage `activity:jets` était indépendant, donc aucun autre astre n'a changé. L'enveloppe de ces trous noirs se réduit à leur disque.
