...
- Pause : suspend la rotation. Mode immersif : dégage l’écran immédiatement ; Échap en sort. L’interface se retire aussi d’elle-même après 10 secondes d’inactivité (2 secondes pendant la dérive de **Découvrir**), pour une vue entièrement dégagée : la barre s’efface en fondu, avec elle la signature, les repères des systèmes et le pointeur de la souris, et il ne reste plus rien à l’écran. Le premier geste la ramène — souris, clic, toucher, molette ou touche, à l’exception des flèches gauche/droite : elles passent à l’astre ou à l’étape suivante sans rappeler l’interface par-dessus la vue ; un mouvement de souris suffit et n’interrompt pas la dérive, et un toucher sur un écran sans souris rappelle la barre sans sélectionner d’astre.
...
Le ratio de pixels est plafonné à 1,75 et descend jusqu’à 0,8 en cas de ralentissement prolongé. Le profil Automatique démarre à 30 images/s et peut monter à 60 si la marge le permet ; Économie vise 30 images/s. La boucle s’arrête dans un onglet masqué et, une fois une scène en pause stabilisée, repart uniquement sur une interaction ou une invalidation utile. Les ressources sont détruites au démontage. Ces limites réduisent la charge ; elles ne mesurent pas la température de l’appareil.
...
### Phénomènes : trous noirs, pulsars, comètes, étoiles doubles et régions

**Options → Phénomènes rares** et la fiche d’un astre donnent accès aux trous noirs et aux pulsars du catalogue actif, regroupés par catégorie. Le premier système en contient toujours un, hors du halo central. Le tirage artistique naturel est de 0,3 % des systèmes. Les pulsars sont activés dans le lot 4, les étoiles doubles dans le lot 5, les nébuleuses et vestiges de supernova dans le lot 7. Le lot 6 active les comètes dans 2 % des systèmes ordinaires : orbites elliptiques, chevelure et deux queues dont la principale pointe à l’opposé de l’étoile. Leur activité augmente à proximité de celle-ci. Le zoom permet d’approcher le noyau et la vue système contient toute l’orbite. [Implémentation et limites de validation du lot 6](docs/local/phenomenes/LOT-6-COMETES.md).
...
Le lot 4 ajoute les pulsars : cœur blanc bleuté, halo local, deux faisceaux inclinés et pulsation douce liée à la direction d’observation, avec une période artistique de 4 à 10 secondes. Le son suit la modulation visuelle. La pause fige la phase ; le mouvement réduit fixe les faisceaux et l’intensité. La caméra reste à l’extérieur, sans commande de surface. Identités, rayons et orbites V2 sont préservés.

Le lot 5 active la seconde source des systèmes binaires, soit 5 % du catalogue. Les deux étoiles tournent en phases opposées autour d’un barycentre invisible, à vitesse angulaire commune et sur des rayons pondérés par des masses artistiques : leur séparation reste constante. Les planètes sont circumbinaires et orbitent la paire entière. La vue système centre le barycentre, qui n’est ni cliquable ni compté dans la densité, tandis que sélectionner une étoile continue de suivre cette étoile. Les planètes détaillées reçoivent deux lumières locales, dont les poids varient continûment et dont les emplacements ne sont jamais permutés, pour qu’une surface en rotation ne scintille pas ; le reflet spéculaire reste sur la source dominante. Les identités, rayons et orbites déjà publiés sont préservés.

Le lot 7 ajoute les régions, premiers objets qui ne sont pas des astres : neuf nébuleuses traversables réparties dans une partition fixe du disque, et un vestige de supernova autour d’environ un système à pulsar sur sept. Une région n’a ni orbite ni indice de sélection, ne compte pas dans la densité et n’intercepte jamais un clic ; on l’atteint par le menu ou par son repère. Le nuage est un volume réellement traversé pas à pas, de seize à quatre pas selon la charge, après que la résolution a atteint son plancher, et son opacité est bornée pour que les étoiles restent lisibles au travers. Deux régions au plus sont **détaillées** à la fois, la région cadrée gardant sa place ; d’autres volumes peuvent rester présents sous forme d’imposteurs ou hors du budget de détail. L’ambiance de la région se mélange à celle de l’astre observé plutôt que de la remplacer. Le vestige mène à son pulsar et réciproquement. Les deux familles sont dimensionnées sur une seule échelle, une fraction du diamètre du disque : un nuage couvre 0,5 à 1,4 % de ce diamètre, une coque environ quatre fois moins, comme dans le ciel réel — le nombre de planètes du pulsar hôte n’entre plus en compte. [Plages, repères et principe d’échelle](docs/PHENOMENES-SPATIAUX.md#échelle-apparente-des-régions). Recette et limites dans [LOT-7-REGIONS.md](docs/local/phenomenes/LOT-7-REGIONS.md).
