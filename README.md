...
### Phénomènes : trous noirs et pulsars

**Options → Phénomènes rares** et la fiche d’un astre donnent accès aux trous noirs et aux pulsars du catalogue actif, regroupés par catégorie. Le premier système en contient toujours un, hors du halo central. Le tirage artistique naturel est de 0,3 % des systèmes ; les binaires utilisent encore une seule source ordinaire de substitution. Les pulsars sont activés dans le lot 4. Les comètes et régions ne sont pas activées.
