...
Le lot 7 ajoute les régions, premiers objets qui ne sont pas des astres : neuf nébuleuses traversables réparties dans une partition fixe du disque, et un vestige de supernova autour d’environ un système à pulsar sur sept. Une région n’a ni orbite ni indice de sélection, ne compte pas dans la densité et n’intercepte jamais un clic ; on l’atteint par le menu ou par son repère. Le nuage est un volume réellement traversé pas à pas, de seize à quatre pas selon la charge, après que la résolution a atteint son plancher, et son opacité est bornée pour que les étoiles restent lisibles au travers. Deux régions au plus sont détaillées à la fois, la région cadrée gardant sa place. L’ambiance de la région se mélange à celle de l’astre observé plutôt que de la remplacer. Le vestige mène à son pulsar et réciproquement. Recette et limites dans [LOT-7-REGIONS.md](docs/local/phenomenes/LOT-7-REGIONS.md).
