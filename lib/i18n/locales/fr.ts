...
export const fr: Dictionary = {
  ...
  quality: {
    ...
    high: 'Élevé',
    ultra: 'Ultra',
    effective: 'Niveau effectif',
    adaptive: 'Auto adaptatif',
    manual: 'Manuel',
    safetyFallback: 'Secours de sûreté',
    tiers: {
      economy: 'Économie',
      balanced: 'Équilibré',
      high: 'Élevé',
    ...
    hint: 'Auto monte progressivement quand la cible FPS tient durablement et baisse avec hystérésis. Les profils manuels restent fixes, sauf secours de sûreté explicite ; Ultra ne plafonne pas le rendu.',
  },
  meta: {
